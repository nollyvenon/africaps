...
<?php echo "<a href=\"exportexcel.php?strSQL=$strSQL\"><img src='assets/images/excelicon.png' width='25' height='25' border='0' /></a> &nbsp;&nbsp;";	
//echo " <a href=\"exporttodoc.php?isvote=1\"><img src='assets/images/mswordicon.jpg' width='25' height='25' border='0' /></a>";	
?>
                                    <table class="table">
                                        <thead>
                                        <tr>
	...
	$qry3 = "SELECT * FROM goalcomrss order by id DESC";
	
	if( $limit=""){$limit = 40; }else{$limit = $_POST['limval'];}
	$totalrows = mysql_num_rows(mysql_query($qry3));
	$page=(int)$_GET['page'];
			if(empty($page)){
  			  $page = 1;
			}
	...
	$sql = mysql_query($qry3." LIMIT $limitvalue,$limit");
...
?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['contdescript']; ?></td>
                                        <td><?php echo $row['actdate']; ?></td>
                                        <td class="center"><?php echo $row['timestamp']; ?></td>
                                        <td><a href="javascript:;" class="edit"><?php echo "<a href='viewcontdet.php?id=$id'>View</a>";?></a></td>
                                    </tr>
<?php					}
		}
?>
