...
<div class="table-responsive mtl">
	...
	$sql = mysql_query("SELECT * FROM subscription order by id");
	...
	$sql = mysql_query("SELECT * FROM subscription order by id DESC LIMIT $limitvalue, $limit");
...
?>
                                    <tr>
                                        ...
                                        <td><a href="javascript:;" class="edit"><?php echo "<a href='updatesubscription.php?id=$id'>Update</a>";?></a></td>
                                    </tr>
<?php					}
		}
?>
