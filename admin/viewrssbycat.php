...
<h4 class="heading-1 clearfix">
    <div class="heading-content">
        Select A Service
        <small>
            Select a service to add content.
        </small>
...
<form id="form1" name="form1" method="post" action="">
                             <table width="607" height="29" border="0" cellpadding="1" cellspacing="1">
                               <tr>
                                 <td width="132" height="22">Select A Service</td>
                                 <td width="468"><label for="services"></label>
                                   <select name="services" id="services" onchange="MM_jumpMenu('parent',this,0)">
                                     <option selected="selected">Select A Service</option>
                                     <?php
		$sql1=mysql_query("SELECT * FROM services WHERE active='1' ORDER by services_id DESC");	
		while($fet1=mysql_fetch_array($sql1)){
			$services_name=$fet1['services_name'];
			echo "<option value=\"dayfeeds1.php?sid=$services_name\">".$services_name."</option>";
		}
