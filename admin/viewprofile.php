...
?>
                ...
                <form action="" method="post" name="form1" class="style61" id="form1">
                          <div class="form-row">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="uname" class="col-md-8" value="<?php echo $adminname; ?>" readonly id="uname" />
                                </div>
                            </div>
                          <div class="form-row">
                                <div class="form-label col-md-4">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="fullname" class="col-md-8" value="<?php echo $fullname; ?>" readonly  id="fullname" />
                                </div>
                            </div>                                          
                          <div class="form-row">
                                <div class="form-label col-md-4">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="phone" class="col-md-8" value="<?php echo $phone; ?>" readonly id="phone" />
                                </div>
                            </div>
                          <div class="form-row">
                                <div class="form-label col-md-4">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="email" class="col-md-8" value="<?php echo $email; ?>" readonly  id="email" />
                                </div>
                            </div>              
                          <div class="form-row">
                                <div class="form-label col-md-4">
                                ...
                                <div class="form-input col-md-8">
                                  <textarea name="address" readonly  class="col-md-8" id="address"><?php echo $address; ?></textarea>
                                </div>
                  </div>
                          <div class="form-row">
                                <div class="form-label col-md-4">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="state" class="col-md-8" value="<?php echo $state; ?>" readonly  id="state" />
                                </div>
                            </div>                                                        
