...
<div class="table-responsive mtl">
	...
	$sql = mysql_query("SELECT * FROM subscribers order by id");
	...
	$sql = mysql_query("SELECT * FROM subscribers order by id DESC LIMIT $limitvalue, $limit");
...
?>
                                    <tr>
                                        ...
                                        <td><a href="javascript:;" class="edit"><?php echo "<a href='updatesubscribers.php?sid=$username'>Update</a>";?></a></td>
                                        <td><a href="javascript:;" class="delete"><?php echo "<a href='deletesubscribers.php?sid=$id'>Delete</a>"; ?></a></td>
                                    </tr>
<?php					}
		}
?>
