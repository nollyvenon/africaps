...
$sid = $_GET['sid'];
$query = "SELECT * FROM admin where adminname='$sid'";
...
$adminname = madSafety($_POST['adminname']);
...
mysql_query("UPDATE admin SET fullname='$fullname',address='$address',phone='$phone',state='$state',email='$email' where adminname='$sid'");
          ...
          <form id="form1" name="form1" method="post" action="">
            <div class="form-row">
                                ...
                                <div class="form-input col-md-8">
                                    <input type="text" name="uname" class="col-md-8" value="<?php echo $adminname; ?>"  id="uname" />
                                </div>
                            </div>
                          <div class="form-row">
                                <div class="form-label col-md-4">
