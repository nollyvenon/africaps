...
<div class="table-responsive mtl">
	...
	$sql = mysql_query("SELECT * FROM admin order by id");
	...
	$sql = mysql_query("SELECT * FROM admin order by id DESC LIMIT $limitvalue, $limit");
...
?>
                                    <tr>
                                        ...
                                        <td><a href="javascript:;" class="edit"><?php echo "<a href='updateadmin.php?sid=$adminname'>Update</a>";?></a></td>
                                        <td><a href="javascript:;" class="delete"><?php echo "<a href='deleteadmin.php?sid=$id'>Delete</a>"; ?></a></td>
                                    </tr>
<?php					}
		}
?>
