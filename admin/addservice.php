...
<form id="form1" name="form1" method="post" action=""  class="col-md-12">
<?php
if ($_POST){
$servicename = $_POST['servicename'];	
//$no_serv = mysql_num_rows(mysql_query("select * from services"));
$sql = mysql_query("INSERT INTO services(services_name) VALUES ('$servicename')");
	  if ($sql){		
		 echo "<div class=\"infobox clearfix infobox-close-wrapper success-bg mrg20B\"> Record added successfully  </div>";
	  }
...
<div class="form-row">                                                        
                                                        ...
                                                        <div class="form-input col-md-8">
                                                            <input name="servicename" required class="col-md-8" type="text" size="50">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-input col-md-2 col-md-offset-2">
                                                            ...
                                                            <input name="submit" value="Add Service" class="btn medium primary-bg radius-all-4" type="submit" />
                                                        </div>
                                                    </div>
                           </form>
                    </div><!-- #page-content -->
