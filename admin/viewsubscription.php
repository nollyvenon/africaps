...
<div class="table-responsive mtl">
	...
	$sql = mysql_query("SELECT * FROM subscriptions order by id");
	...
	$sql = mysql_query("SELECT * FROM subscriptions order by id DESC LIMIT $limitvalue, $limit");
...
?>
                                    <tr>
                                        ...
                                        <td><?php echo $row['paid_from']; ?></td>
                                        <td><?php echo $row['paid_until']; ?></td>
                                        <td><?php echo $row['cost']; ?></td>
                                <!--        <td><a href="javascript:;" class="edit"><?php echo "<a href='deleteservices.php?id=$id'>Delete</a>";?></a></td>-->
                                    </tr>
<?php					}
		}
?>
